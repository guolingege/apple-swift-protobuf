...
enum ProtobufUnittestImport_ImportEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
enum ProtobufUnittestImport_ImportEnumForMap: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case unknown // = 0
  case foo // = 1
  case bar // = 2
...
extension ProtobufUnittestImport_ImportEnum: AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittestImport_ImportEnumForMap: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension ProtobufUnittestImport_ImportMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
