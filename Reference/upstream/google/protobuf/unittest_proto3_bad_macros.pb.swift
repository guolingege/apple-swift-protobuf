...
enum ProtobufUnittest_GID: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
enum ProtobufUnittest_UID: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case unused // = 0
  case UNRECOGNIZED(Int)
...
enum ProtobufUnittest_BadNames: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
...
extension ProtobufUnittest_GID: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "GID_UNUSED"),
  ]
}

extension ProtobufUnittest_UID: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "UID_UNUSED"),
  ]
}

extension ProtobufUnittest_BadNames: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
