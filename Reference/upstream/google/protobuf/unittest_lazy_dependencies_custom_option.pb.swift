...
let ProtobufUnittest_LazyImports_UnittestLazyDependenciesCustomOption_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
let ProtobufUnittest_LazyImports_Extensions_lazy_enum_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<ProtobufUnittest_LazyImports_LazyEnum>, AppleSwiftProtobuf.Google_Protobuf_MessageOptions>(
...
extension ProtobufUnittest_LazyImports_LazyMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
