...
enum EditionUnittest_ForeignEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
enum EditionUnittest_TestReservedEnumFields: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case unknown // = 0
...
enum EditionUnittest_TestEnumWithDupValue: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case dupUnknown1 // = 0
  case dupFoo1 // = 1
  case dupBar1 // = 2
...
enum EditionUnittest_TestSparseEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case sparseA // = 123
  case sparseB // = 62374
...
enum EditionUnittest_VeryLargeEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
...
struct EditionUnittest_TestAllExtensions: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestMixedFieldsAndExtensions: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestGroupExtension: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestEmptyMessageWithExtensions: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestMultipleExtensionRanges: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestFieldOrderings: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestPackedExtensions: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestUnpackedExtensions: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestParsingMerge: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestHugeFieldNumbers: AppleSwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestExtensionInsideTable: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_TestExtensionRangeSerialize: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_EnumParseTester: AppleSwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_BoolParseTester: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_Int32ParseTester: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_Int64ParseTester: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct EditionUnittest_StringParseTester: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
let EditionUnittest_EditionUnittest_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
/// Singular
let EditionUnittest_Extensions_optional_int32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 1,
  fieldName: "edition_unittest.optional_int32_extension"
)

let EditionUnittest_Extensions_optional_int64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 2,
  fieldName: "edition_unittest.optional_int64_extension"
)

let EditionUnittest_Extensions_optional_uint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufUInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 3,
  fieldName: "edition_unittest.optional_uint32_extension"
)

let EditionUnittest_Extensions_optional_uint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufUInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 4,
  fieldName: "edition_unittest.optional_uint64_extension"
)

let EditionUnittest_Extensions_optional_sint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufSInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 5,
  fieldName: "edition_unittest.optional_sint32_extension"
)

let EditionUnittest_Extensions_optional_sint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufSInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 6,
  fieldName: "edition_unittest.optional_sint64_extension"
)

let EditionUnittest_Extensions_optional_fixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufFixed32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 7,
  fieldName: "edition_unittest.optional_fixed32_extension"
)

let EditionUnittest_Extensions_optional_fixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufFixed64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 8,
  fieldName: "edition_unittest.optional_fixed64_extension"
)

let EditionUnittest_Extensions_optional_sfixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufSFixed32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 9,
  fieldName: "edition_unittest.optional_sfixed32_extension"
)

let EditionUnittest_Extensions_optional_sfixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufSFixed64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 10,
  fieldName: "edition_unittest.optional_sfixed64_extension"
)

let EditionUnittest_Extensions_optional_float_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufFloat>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 11,
  fieldName: "edition_unittest.optional_float_extension"
)

let EditionUnittest_Extensions_optional_double_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufDouble>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 12,
  fieldName: "edition_unittest.optional_double_extension"
)

let EditionUnittest_Extensions_optional_bool_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 13,
  fieldName: "edition_unittest.optional_bool_extension"
)

let EditionUnittest_Extensions_optional_string_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 14,
  fieldName: "edition_unittest.optional_string_extension"
)

let EditionUnittest_Extensions_optional_bytes_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBytes>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 15,
  fieldName: "edition_unittest.optional_bytes_extension"
)

let EditionUnittest_Extensions_OptionalGroup_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalGroupExtensionField<EditionUnittest_OptionalGroup_extension>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 16,
  fieldName: "edition_unittest.optionalgroup_extension"
)

let EditionUnittest_Extensions_optional_nested_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestAllTypes.NestedMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 18,
  fieldName: "edition_unittest.optional_nested_message_extension"
)

let EditionUnittest_Extensions_optional_foreign_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_ForeignMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 19,
  fieldName: "edition_unittest.optional_foreign_message_extension"
)

let EditionUnittest_Extensions_optional_import_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittestImport_ImportMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 20,
  fieldName: "edition_unittest.optional_import_message_extension"
)

let EditionUnittest_Extensions_optional_nested_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<EditionUnittest_TestAllTypes.NestedEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 21,
  fieldName: "edition_unittest.optional_nested_enum_extension"
)

let EditionUnittest_Extensions_optional_foreign_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<EditionUnittest_ForeignEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 22,
  fieldName: "edition_unittest.optional_foreign_enum_extension"
)

let EditionUnittest_Extensions_optional_import_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<ProtobufUnittestImport_ImportEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 23,
  fieldName: "edition_unittest.optional_import_enum_extension"
)

let EditionUnittest_Extensions_optional_string_piece_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
...
/// TODO: ctype=CORD is not supported for extension. Add
/// ctype=CORD option back after it is supported.
let EditionUnittest_Extensions_optional_cord_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 25,
  fieldName: "edition_unittest.optional_cord_extension"
)

let EditionUnittest_Extensions_optional_bytes_cord_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBytes>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 86,
  fieldName: "edition_unittest.optional_bytes_cord_extension"
)

let EditionUnittest_Extensions_optional_public_import_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittestImport_PublicImportMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 26,
  fieldName: "edition_unittest.optional_public_import_message_extension"
)

let EditionUnittest_Extensions_optional_lazy_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestAllTypes.NestedMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 27,
  fieldName: "edition_unittest.optional_lazy_message_extension"
)

let EditionUnittest_Extensions_optional_unverified_lazy_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestAllTypes.NestedMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 28,
  fieldName: "edition_unittest.optional_unverified_lazy_message_extension"
)

/// Repeated
let EditionUnittest_Extensions_repeated_int32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 31,
  fieldName: "edition_unittest.repeated_int32_extension"
)

let EditionUnittest_Extensions_repeated_int64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 32,
  fieldName: "edition_unittest.repeated_int64_extension"
)

let EditionUnittest_Extensions_repeated_uint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufUInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 33,
  fieldName: "edition_unittest.repeated_uint32_extension"
)

let EditionUnittest_Extensions_repeated_uint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufUInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 34,
  fieldName: "edition_unittest.repeated_uint64_extension"
)

let EditionUnittest_Extensions_repeated_sint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufSInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 35,
  fieldName: "edition_unittest.repeated_sint32_extension"
)

let EditionUnittest_Extensions_repeated_sint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufSInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 36,
  fieldName: "edition_unittest.repeated_sint64_extension"
)

let EditionUnittest_Extensions_repeated_fixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufFixed32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 37,
  fieldName: "edition_unittest.repeated_fixed32_extension"
)

let EditionUnittest_Extensions_repeated_fixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufFixed64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 38,
  fieldName: "edition_unittest.repeated_fixed64_extension"
)

let EditionUnittest_Extensions_repeated_sfixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufSFixed32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 39,
  fieldName: "edition_unittest.repeated_sfixed32_extension"
)

let EditionUnittest_Extensions_repeated_sfixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufSFixed64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 40,
  fieldName: "edition_unittest.repeated_sfixed64_extension"
)

let EditionUnittest_Extensions_repeated_float_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufFloat>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 41,
  fieldName: "edition_unittest.repeated_float_extension"
)

let EditionUnittest_Extensions_repeated_double_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufDouble>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 42,
  fieldName: "edition_unittest.repeated_double_extension"
)

let EditionUnittest_Extensions_repeated_bool_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufBool>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 43,
  fieldName: "edition_unittest.repeated_bool_extension"
)

let EditionUnittest_Extensions_repeated_string_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 44,
  fieldName: "edition_unittest.repeated_string_extension"
)

let EditionUnittest_Extensions_repeated_bytes_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufBytes>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 45,
  fieldName: "edition_unittest.repeated_bytes_extension"
)

let EditionUnittest_Extensions_RepeatedGroup_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedGroupExtensionField<EditionUnittest_RepeatedGroup_extension>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 46,
  fieldName: "edition_unittest.repeatedgroup_extension"
)

let EditionUnittest_Extensions_repeated_nested_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedMessageExtensionField<EditionUnittest_TestAllTypes.NestedMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 48,
  fieldName: "edition_unittest.repeated_nested_message_extension"
)

let EditionUnittest_Extensions_repeated_foreign_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedMessageExtensionField<EditionUnittest_ForeignMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 49,
  fieldName: "edition_unittest.repeated_foreign_message_extension"
)

let EditionUnittest_Extensions_repeated_import_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedMessageExtensionField<ProtobufUnittestImport_ImportMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 50,
  fieldName: "edition_unittest.repeated_import_message_extension"
)

let EditionUnittest_Extensions_repeated_nested_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedEnumExtensionField<EditionUnittest_TestAllTypes.NestedEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 51,
  fieldName: "edition_unittest.repeated_nested_enum_extension"
)

let EditionUnittest_Extensions_repeated_foreign_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedEnumExtensionField<EditionUnittest_ForeignEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 52,
  fieldName: "edition_unittest.repeated_foreign_enum_extension"
)

let EditionUnittest_Extensions_repeated_import_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedEnumExtensionField<ProtobufUnittestImport_ImportEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 53,
  fieldName: "edition_unittest.repeated_import_enum_extension"
)

let EditionUnittest_Extensions_repeated_string_piece_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
...
/// TODO: ctype=CORD is not supported for extension. Add
/// ctype=CORD option back after it is supported.
let EditionUnittest_Extensions_repeated_cord_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 55,
  fieldName: "edition_unittest.repeated_cord_extension"
)

let EditionUnittest_Extensions_repeated_lazy_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedMessageExtensionField<EditionUnittest_TestAllTypes.NestedMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 57,
  fieldName: "edition_unittest.repeated_lazy_message_extension"
)

/// Singular with defaults
let EditionUnittest_Extensions_default_int32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 61,
  fieldName: "edition_unittest.default_int32_extension"
)

let EditionUnittest_Extensions_default_int64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 62,
  fieldName: "edition_unittest.default_int64_extension"
)

let EditionUnittest_Extensions_default_uint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufUInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 63,
  fieldName: "edition_unittest.default_uint32_extension"
)

let EditionUnittest_Extensions_default_uint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufUInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 64,
  fieldName: "edition_unittest.default_uint64_extension"
)

let EditionUnittest_Extensions_default_sint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufSInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 65,
  fieldName: "edition_unittest.default_sint32_extension"
)

let EditionUnittest_Extensions_default_sint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufSInt64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 66,
  fieldName: "edition_unittest.default_sint64_extension"
)

let EditionUnittest_Extensions_default_fixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufFixed32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 67,
  fieldName: "edition_unittest.default_fixed32_extension"
)

let EditionUnittest_Extensions_default_fixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufFixed64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 68,
  fieldName: "edition_unittest.default_fixed64_extension"
)

let EditionUnittest_Extensions_default_sfixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufSFixed32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 69,
  fieldName: "edition_unittest.default_sfixed32_extension"
)

let EditionUnittest_Extensions_default_sfixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufSFixed64>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 70,
  fieldName: "edition_unittest.default_sfixed64_extension"
)

let EditionUnittest_Extensions_default_float_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufFloat>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 71,
  fieldName: "edition_unittest.default_float_extension"
)

let EditionUnittest_Extensions_default_double_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufDouble>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 72,
  fieldName: "edition_unittest.default_double_extension"
)

let EditionUnittest_Extensions_default_bool_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 73,
  fieldName: "edition_unittest.default_bool_extension"
)

let EditionUnittest_Extensions_default_string_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 74,
  fieldName: "edition_unittest.default_string_extension"
)

let EditionUnittest_Extensions_default_bytes_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBytes>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 75,
  fieldName: "edition_unittest.default_bytes_extension"
)

let EditionUnittest_Extensions_default_nested_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<EditionUnittest_TestAllTypes.NestedEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 81,
  fieldName: "edition_unittest.default_nested_enum_extension"
)

let EditionUnittest_Extensions_default_foreign_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<EditionUnittest_ForeignEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 82,
  fieldName: "edition_unittest.default_foreign_enum_extension"
)

let EditionUnittest_Extensions_default_import_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<ProtobufUnittestImport_ImportEnum>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 83,
  fieldName: "edition_unittest.default_import_enum_extension"
)

let EditionUnittest_Extensions_default_string_piece_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
...
/// TODO: ctype=CORD is not supported for extension. Add
/// ctype=CORD option back after it is supported.
let EditionUnittest_Extensions_default_cord_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 85,
  fieldName: "edition_unittest.default_cord_extension"
)

/// For oneof test
let EditionUnittest_Extensions_oneof_uint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufUInt32>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 111,
  fieldName: "edition_unittest.oneof_uint32_extension"
)

let EditionUnittest_Extensions_oneof_nested_message_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestAllTypes.NestedMessage>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 112,
  fieldName: "edition_unittest.oneof_nested_message_extension"
)

let EditionUnittest_Extensions_oneof_string_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 113,
  fieldName: "edition_unittest.oneof_string_extension"
)

let EditionUnittest_Extensions_oneof_bytes_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBytes>, EditionUnittest_TestAllExtensions>(
  _protobuf_fieldNumber: 114,
  fieldName: "edition_unittest.oneof_bytes_extension"
)

let EditionUnittest_Extensions_my_extension_string = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestFieldOrderings>(
  _protobuf_fieldNumber: 50,
  fieldName: "edition_unittest.my_extension_string"
)

let EditionUnittest_Extensions_my_extension_int = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestFieldOrderings>(
  _protobuf_fieldNumber: 5,
  fieldName: "edition_unittest.my_extension_int"
)

let EditionUnittest_Extensions_packed_int32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 90,
  fieldName: "edition_unittest.packed_int32_extension"
)

let EditionUnittest_Extensions_packed_int64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt64>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 91,
  fieldName: "edition_unittest.packed_int64_extension"
)

let EditionUnittest_Extensions_packed_uint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufUInt32>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 92,
  fieldName: "edition_unittest.packed_uint32_extension"
)

let EditionUnittest_Extensions_packed_uint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufUInt64>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 93,
  fieldName: "edition_unittest.packed_uint64_extension"
)

let EditionUnittest_Extensions_packed_sint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufSInt32>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 94,
  fieldName: "edition_unittest.packed_sint32_extension"
)

let EditionUnittest_Extensions_packed_sint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufSInt64>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 95,
  fieldName: "edition_unittest.packed_sint64_extension"
)

let EditionUnittest_Extensions_packed_fixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufFixed32>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 96,
  fieldName: "edition_unittest.packed_fixed32_extension"
)

let EditionUnittest_Extensions_packed_fixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufFixed64>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 97,
  fieldName: "edition_unittest.packed_fixed64_extension"
)

let EditionUnittest_Extensions_packed_sfixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufSFixed32>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 98,
  fieldName: "edition_unittest.packed_sfixed32_extension"
)

let EditionUnittest_Extensions_packed_sfixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufSFixed64>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 99,
  fieldName: "edition_unittest.packed_sfixed64_extension"
)

let EditionUnittest_Extensions_packed_float_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufFloat>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 100,
  fieldName: "edition_unittest.packed_float_extension"
)

let EditionUnittest_Extensions_packed_double_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufDouble>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 101,
  fieldName: "edition_unittest.packed_double_extension"
)

let EditionUnittest_Extensions_packed_bool_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufBool>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 102,
  fieldName: "edition_unittest.packed_bool_extension"
)

let EditionUnittest_Extensions_packed_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedEnumExtensionField<EditionUnittest_ForeignEnum>, EditionUnittest_TestPackedExtensions>(
  _protobuf_fieldNumber: 103,
  fieldName: "edition_unittest.packed_enum_extension"
)

let EditionUnittest_Extensions_unpacked_int32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 90,
  fieldName: "edition_unittest.unpacked_int32_extension"
)

let EditionUnittest_Extensions_unpacked_int64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufInt64>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 91,
  fieldName: "edition_unittest.unpacked_int64_extension"
)

let EditionUnittest_Extensions_unpacked_uint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufUInt32>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 92,
  fieldName: "edition_unittest.unpacked_uint32_extension"
)

let EditionUnittest_Extensions_unpacked_uint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufUInt64>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 93,
  fieldName: "edition_unittest.unpacked_uint64_extension"
)

let EditionUnittest_Extensions_unpacked_sint32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufSInt32>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 94,
  fieldName: "edition_unittest.unpacked_sint32_extension"
)

let EditionUnittest_Extensions_unpacked_sint64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufSInt64>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 95,
  fieldName: "edition_unittest.unpacked_sint64_extension"
)

let EditionUnittest_Extensions_unpacked_fixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufFixed32>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 96,
  fieldName: "edition_unittest.unpacked_fixed32_extension"
)

let EditionUnittest_Extensions_unpacked_fixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufFixed64>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 97,
  fieldName: "edition_unittest.unpacked_fixed64_extension"
)

let EditionUnittest_Extensions_unpacked_sfixed32_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufSFixed32>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 98,
  fieldName: "edition_unittest.unpacked_sfixed32_extension"
)

let EditionUnittest_Extensions_unpacked_sfixed64_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufSFixed64>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 99,
  fieldName: "edition_unittest.unpacked_sfixed64_extension"
)

let EditionUnittest_Extensions_unpacked_float_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufFloat>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 100,
  fieldName: "edition_unittest.unpacked_float_extension"
)

let EditionUnittest_Extensions_unpacked_double_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufDouble>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 101,
  fieldName: "edition_unittest.unpacked_double_extension"
)

let EditionUnittest_Extensions_unpacked_bool_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufBool>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 102,
  fieldName: "edition_unittest.unpacked_bool_extension"
)

let EditionUnittest_Extensions_unpacked_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedEnumExtensionField<EditionUnittest_ForeignEnum>, EditionUnittest_TestUnpackedExtensions>(
  _protobuf_fieldNumber: 103,
  fieldName: "edition_unittest.unpacked_enum_extension"
)

let EditionUnittest_Extensions_test_all_types = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestAllTypes>, EditionUnittest_TestHugeFieldNumbers>(
  _protobuf_fieldNumber: 536860000,
  fieldName: "edition_unittest.test_all_types"
)

let EditionUnittest_Extensions_test_extension_inside_table_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestExtensionInsideTable>(
  _protobuf_fieldNumber: 5,
  fieldName: "edition_unittest.test_extension_inside_table_extension"
)

let EditionUnittest_Extensions_inner = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestNestedGroupExtensionInnerExtension>, EditionUnittest_TestNestedGroupExtensionOuter.Layer1OptionalGroup.Layer2RepeatedGroup>(
  _protobuf_fieldNumber: 3,
...
extension EditionUnittest_TestMixedFieldsAndExtensions {
  enum Extensions {
    static let c = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestMixedFieldsAndExtensions>(
      _protobuf_fieldNumber: 2,
      fieldName: "edition_unittest.TestMixedFieldsAndExtensions.c"
    )

    static let d = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufFixed32>, EditionUnittest_TestMixedFieldsAndExtensions>(
      _protobuf_fieldNumber: 4,
...
extension EditionUnittest_TestNestedExtension {
  enum Extensions {
    /// Check for bug where string extensions declared in tested scope did not
    /// compile.
    static let test = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
    ...
    /// Used to test if generated extension name is correct when there are
    /// underscores.
    static let nested_string_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_TestAllExtensions>(
      _protobuf_fieldNumber: 1003,
      fieldName: "edition_unittest.TestNestedExtension.nested_string_extension"
    )

    static let OptionalGroup_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalGroupExtensionField<EditionUnittest_TestNestedExtension.OptionalGroup_extension>, EditionUnittest_TestGroupExtension>(
      _protobuf_fieldNumber: 16,
      fieldName: "edition_unittest.TestNestedExtension.optionalgroup_extension"
    )

    static let optional_foreign_enum_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<EditionUnittest_ForeignEnum>, EditionUnittest_TestGroupExtension>(
      _protobuf_fieldNumber: 22,
...
extension EditionUnittest_TestRequired {
  enum Extensions {
    static let single = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestRequired>, EditionUnittest_TestAllExtensions>(
      _protobuf_fieldNumber: 1000,
      fieldName: "edition_unittest.TestRequired.single"
    )

    static let multi = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedMessageExtensionField<EditionUnittest_TestRequired>, EditionUnittest_TestAllExtensions>(
...
extension EditionUnittest_TestExtensionOrderings1 {
  enum Extensions {
    static let test_ext_orderings1 = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestExtensionOrderings1>, EditionUnittest_TestFieldOrderings>(
      _protobuf_fieldNumber: 13,
...
extension EditionUnittest_TestExtensionOrderings2 {
  enum Extensions {
    static let test_ext_orderings2 = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestExtensionOrderings2>, EditionUnittest_TestFieldOrderings>(
      _protobuf_fieldNumber: 12,
...
extension EditionUnittest_TestExtensionOrderings2.TestExtensionOrderings3 {
  enum Extensions {
    static let test_ext_orderings3 = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestExtensionOrderings2.TestExtensionOrderings3>, EditionUnittest_TestFieldOrderings>(
      _protobuf_fieldNumber: 14,
...
extension EditionUnittest_TestParsingMerge {
  enum Extensions {
    static let optional_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<EditionUnittest_TestAllTypes>, EditionUnittest_TestParsingMerge>(
      _protobuf_fieldNumber: 1000,
      fieldName: "edition_unittest.TestParsingMerge.optional_ext"
    )

    static let repeated_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedMessageExtensionField<EditionUnittest_TestAllTypes>, EditionUnittest_TestParsingMerge>(
      _protobuf_fieldNumber: 1001,
...
extension EditionUnittest_TestExtensionRangeSerialize {
  enum Extensions {
    static let bar_one = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestExtensionRangeSerialize>(
      _protobuf_fieldNumber: 2,
      fieldName: "edition_unittest.TestExtensionRangeSerialize.bar_one"
    )

    static let bar_two = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestExtensionRangeSerialize>(
      _protobuf_fieldNumber: 4,
      fieldName: "edition_unittest.TestExtensionRangeSerialize.bar_two"
    )

    static let bar_three = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestExtensionRangeSerialize>(
      _protobuf_fieldNumber: 10,
      fieldName: "edition_unittest.TestExtensionRangeSerialize.bar_three"
    )

    static let bar_four = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestExtensionRangeSerialize>(
      _protobuf_fieldNumber: 15,
      fieldName: "edition_unittest.TestExtensionRangeSerialize.bar_four"
    )

    static let bar_five = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_TestExtensionRangeSerialize>(
      _protobuf_fieldNumber: 19,
...
extension EditionUnittest_EnumParseTester {
  enum Extensions {
    static let optional_arbitrary_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalEnumExtensionField<EditionUnittest_EnumParseTester.Arbitrary>, EditionUnittest_EnumParseTester>(
      _protobuf_fieldNumber: 2000000,
      fieldName: "edition_unittest.EnumParseTester.optional_arbitrary_ext"
    )

    static let repeated_arbitrary_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedEnumExtensionField<EditionUnittest_EnumParseTester.Arbitrary>, EditionUnittest_EnumParseTester>(
      _protobuf_fieldNumber: 2000001,
      fieldName: "edition_unittest.EnumParseTester.repeated_arbitrary_ext"
    )

    static let packed_arbitrary_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedEnumExtensionField<EditionUnittest_EnumParseTester.Arbitrary>, EditionUnittest_EnumParseTester>(
...
extension EditionUnittest_BoolParseTester {
  enum Extensions {
    static let optional_bool_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, EditionUnittest_BoolParseTester>(
      _protobuf_fieldNumber: 2000000,
      fieldName: "edition_unittest.BoolParseTester.optional_bool_ext"
    )

    static let repeated_bool_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufBool>, EditionUnittest_BoolParseTester>(
      _protobuf_fieldNumber: 2000001,
      fieldName: "edition_unittest.BoolParseTester.repeated_bool_ext"
    )

    static let packed_bool_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufBool>, EditionUnittest_BoolParseTester>(
      _protobuf_fieldNumber: 2000002,
...
extension EditionUnittest_Int32ParseTester {
  enum Extensions {
    static let optional_int32_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_Int32ParseTester>(
      _protobuf_fieldNumber: 2000000,
      fieldName: "edition_unittest.Int32ParseTester.optional_int32_ext"
    )

    static let repeated_int32_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_Int32ParseTester>(
      _protobuf_fieldNumber: 2000001,
      fieldName: "edition_unittest.Int32ParseTester.repeated_int32_ext"
    )

    static let packed_int32_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt32>, EditionUnittest_Int32ParseTester>(
      _protobuf_fieldNumber: 2000002,
...
extension EditionUnittest_Int64ParseTester {
  enum Extensions {
    static let optional_int64_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt64>, EditionUnittest_Int64ParseTester>(
      _protobuf_fieldNumber: 2000000,
      fieldName: "edition_unittest.Int64ParseTester.optional_int64_ext"
    )

    static let repeated_int64_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt64>, EditionUnittest_Int64ParseTester>(
      _protobuf_fieldNumber: 2000001,
      fieldName: "edition_unittest.Int64ParseTester.repeated_int64_ext"
    )

    static let packed_int64_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt64>, EditionUnittest_Int64ParseTester>(
      _protobuf_fieldNumber: 2000002,
...
extension EditionUnittest_StringParseTester {
  enum Extensions {
    static let optional_string_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_StringParseTester>(
      _protobuf_fieldNumber: 2000000,
      fieldName: "edition_unittest.StringParseTester.optional_string_ext"
    )

    static let repeated_string_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufString>, EditionUnittest_StringParseTester>(
      _protobuf_fieldNumber: 2000001,
...
extension EditionUnittest_ForeignEnum: AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestReservedEnumFields: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "UNKNOWN"),
  ]
}

extension EditionUnittest_TestEnumWithDupValue: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension EditionUnittest_TestSparseEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension EditionUnittest_VeryLargeEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension EditionUnittest_TestAllTypes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestAllTypes.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    -1: .same(proto: "NEG"),
    1: .same(proto: "FOO"),
    2: .same(proto: "BAR"),
...
extension EditionUnittest_TestAllTypes.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestAllTypes.OptionalGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestAllTypes.RepeatedGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_NestedTestAllTypes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestDeprecatedFields: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestDeprecatedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_ForeignMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestReservedFields: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestAllExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_OptionalGroup_extension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_RepeatedGroup_extension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMixedFieldsAndExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestGroup.OptionalGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestGroupExtension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedExtension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedExtension.OptionalGroup_extension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestChildExtension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestChildExtensionData: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestChildExtensionData.NestedTestAllExtensionsData: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestChildExtensionData.NestedTestAllExtensionsData.NestedDynamicExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedChildExtension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedChildExtensionData: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredEnum: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredEnumNoMask: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredEnumNoMask.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    -1: .same(proto: "BAZ"),
...
extension EditionUnittest_TestRequiredEnumMulti: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredEnumMulti.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "UNSPECIFIED"),
    1: .same(proto: "FOO"),
    2: .same(proto: "BAR"),
...
extension EditionUnittest_TestRequiredNoMaskMulti: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredNoMaskMulti.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "UNSPECIFIED"),
    1: .same(proto: "FOO"),
    2: .same(proto: "BAR"),
...
extension EditionUnittest_TestRequired: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredForeign: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedRequiredForeign: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestForeignNested: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestEmptyMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestEmptyMessageWithExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestPickleNestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestPickleNestedMessage.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestPickleNestedMessage.NestedMessage.NestedNestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMultipleExtensionRanges: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestReallyLargeTagNumber: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRecursiveMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMutualRecursionA: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMutualRecursionA.SubMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMutualRecursionA.SubGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMutualRecursionA.SubGroupR: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMutualRecursionB: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestIsInitialized: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestIsInitialized.SubMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestIsInitialized.SubMessage.SubGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestDupFieldNumber: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestDupFieldNumber.Foo: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestDupFieldNumber.Bar: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestEagerMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestLazyMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestLazyMessageRepeated: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestEagerMaybeLazy: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestEagerMaybeLazy.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedMessageHasBits: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedMessageHasBits.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestCamelCaseFieldNames: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestFieldOrderings: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestFieldOrderings.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestExtensionOrderings1: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestExtensionOrderings2: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestExtensionOrderings2.TestExtensionOrderings3: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestExtremeDefaultValues: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_SparseEnumMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_OneString: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_MoreString: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_OneBytes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_MoreBytes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_ManyOptionalString: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_Int32Message: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_Uint32Message: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_Int64Message: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_Uint64Message: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_BoolMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestOneof: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestOneof.FooGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestOneofBackwardsCompatible: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestOneofBackwardsCompatible.FooGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestOneof2: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestOneof2.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "UNKNOWN"),
    1: .same(proto: "FOO"),
    2: .same(proto: "BAR"),
...
extension EditionUnittest_TestOneof2.FooGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestOneof2.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredOneof: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRequiredOneof.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestPackedTypes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestUnpackedTypes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestPackedExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestUnpackedExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestDynamicExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestDynamicExtensions.DynamicEnumType: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension EditionUnittest_TestDynamicExtensions.DynamicMessageType: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRepeatedString: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestRepeatedScalarDifferentTagSizes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestParsingMerge: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestParsingMerge.RepeatedFieldsGenerator: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestParsingMerge.RepeatedFieldsGenerator.Group1: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestParsingMerge.RepeatedFieldsGenerator.Group2: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestParsingMerge.OptionalGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestParsingMerge.RepeatedGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMergeException: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestCommentInjectionMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestMessageSize: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_FooRequest: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_FooResponse: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_FooClientMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_FooServerMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_BarRequest: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_BarResponse: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestJsonName: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestHugeFieldNumbers: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestHugeFieldNumbers.OptionalGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestExtensionInsideTable: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedGroupExtensionOuter: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedGroupExtensionOuter.Layer1OptionalGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedGroupExtensionOuter.Layer1OptionalGroup.Layer2RepeatedGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedGroupExtensionOuter.Layer1OptionalGroup.Layer2AnotherOptionalRepeatedGroup: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedGroupExtensionInnerExtension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestExtensionRangeSerialize: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyInt32Simple: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyInt32: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyMostlyInt32: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyMostlyInt32BigFieldNumber: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyUint32Simple: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyUint32: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyOneUint32: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyOneInt32BigFieldNumber: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyInt32BigFieldNumber: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyUint32BigFieldNumber: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyBigFieldNumberUint32: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestVerifyBigFieldNumberUint32.Nested: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_EnumParseTester: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_EnumParseTester.SeqSmall0: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension EditionUnittest_EnumParseTester.SeqSmall1: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "UNKNOWN"),
...
extension EditionUnittest_EnumParseTester.SeqLarge: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension EditionUnittest_EnumParseTester.Arbitrary: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension EditionUnittest_BoolParseTester: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_Int32ParseTester: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_Int64ParseTester: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_InlinedStringIdxRegressionProto: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_StringParseTester: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_BadFieldNames: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestNestedMessageRedaction: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_RedactedFields: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestCord: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestPackedEnumSmallRange: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_TestPackedEnumSmallRange.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "UNSPECIFIED"),
    1: .same(proto: "FOO"),
    2: .same(proto: "BAR"),
...
extension EditionUnittest_EnumsForBenchmark: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension EditionUnittest_EnumsForBenchmark.Flat: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "A0"),
    1: .same(proto: "A1"),
    2: .same(proto: "A2"),
...
extension EditionUnittest_EnumsForBenchmark.AlmostFlat: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "B0"),
    1: .same(proto: "B1"),
    2: .same(proto: "B2"),
...
extension EditionUnittest_EnumsForBenchmark.Sparse: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "C0"),
    536: .same(proto: "C536"),
...
extension EditionUnittest_TestMessageWithManyRepeatedPtrFields: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
