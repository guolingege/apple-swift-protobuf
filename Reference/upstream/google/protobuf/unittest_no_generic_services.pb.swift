...
enum ProtobufUnittest_NoGenericServicesTest_TestEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
struct ProtobufUnittest_NoGenericServicesTest_TestMessage: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
...
let ProtobufUnittest_NoGenericServicesTest_UnittestNoGenericServices_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
let ProtobufUnittest_NoGenericServicesTest_Extensions_test_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, ProtobufUnittest_NoGenericServicesTest_TestMessage>(
...
extension ProtobufUnittest_NoGenericServicesTest_TestEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    1: .same(proto: "FOO"),
  ]
}

extension ProtobufUnittest_NoGenericServicesTest_TestMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
