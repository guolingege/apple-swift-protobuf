...
enum Proto3PreserveUnknownEnumUnittest_MyEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
enum Proto3PreserveUnknownEnumUnittest_MyEnumPlusExtra: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case eFoo // = 0
  case eBar // = 1
  case eBaz // = 2
...
extension Proto3PreserveUnknownEnumUnittest_MyEnum: AppleSwiftProtobuf._ProtoNameProviding {
...
extension Proto3PreserveUnknownEnumUnittest_MyEnumPlusExtra: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "E_FOO"),
    1: .same(proto: "E_BAR"),
    2: .same(proto: "E_BAZ"),
...
extension Proto3PreserveUnknownEnumUnittest_MyMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension Proto3PreserveUnknownEnumUnittest_MyMessagePlusExtra: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
