...
enum Proto2NofieldpresenceUnittest_ForeignEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
extension Proto2NofieldpresenceUnittest_ForeignEnum: AppleSwiftProtobuf._ProtoNameProviding {
...
extension Proto2NofieldpresenceUnittest_TestAllTypes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension Proto2NofieldpresenceUnittest_TestAllTypes.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "FOO"),
    1: .same(proto: "BAR"),
    2: .same(proto: "BAZ"),
...
extension Proto2NofieldpresenceUnittest_TestAllTypes.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension Proto2NofieldpresenceUnittest_TestAllMapTypes: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: AppleSwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMap<AppleSwiftProtobuf.ProtobufInt32,AppleSwiftProtobuf.ProtobufBytes>.self, value: &self.mapInt32Bytes) }()
      case 2: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufInt32,Proto2NofieldpresenceUnittest_ForeignEnum>.self, value: &self.mapInt32ForeignEnum) }()
      case 3: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufInt32,Proto2NofieldpresenceUnittest_ForeignMessage>.self, value: &self.mapInt32ForeignMessage) }()
      case 4: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufInt32,Proto2NofieldpresenceUnittest_ExplicitForeignMessage>.self, value: &self.mapInt32ExplicitForeignMessage) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: AppleSwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.mapInt32Bytes.isEmpty {
      try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMap<AppleSwiftProtobuf.ProtobufInt32,AppleSwiftProtobuf.ProtobufBytes>.self, value: self.mapInt32Bytes, fieldNumber: 1)
    }
    if !self.mapInt32ForeignEnum.isEmpty {
      try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufInt32,Proto2NofieldpresenceUnittest_ForeignEnum>.self, value: self.mapInt32ForeignEnum, fieldNumber: 2)
    }
    if !self.mapInt32ForeignMessage.isEmpty {
      try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufInt32,Proto2NofieldpresenceUnittest_ForeignMessage>.self, value: self.mapInt32ForeignMessage, fieldNumber: 3)
    }
    if !self.mapInt32ExplicitForeignMessage.isEmpty {
      try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufInt32,Proto2NofieldpresenceUnittest_ExplicitForeignMessage>.self, value: self.mapInt32ExplicitForeignMessage, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Proto2NofieldpresenceUnittest_TestProto2Required: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension Proto2NofieldpresenceUnittest_ForeignMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension Proto2NofieldpresenceUnittest_ExplicitForeignMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
