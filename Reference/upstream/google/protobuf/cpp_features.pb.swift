...
struct Pb_CppFeatures: Sendable {
  ...
  enum StringType: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
let Pb_CppFeatures_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
  Pb_Extensions_cpp
]
...
let Pb_Extensions_cpp = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<Pb_CppFeatures>, AppleSwiftProtobuf.Google_Protobuf_FeatureSet>(
...
extension Pb_CppFeatures: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension Pb_CppFeatures.StringType: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
