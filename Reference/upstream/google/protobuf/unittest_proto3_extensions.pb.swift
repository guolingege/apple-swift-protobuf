...
let ProtobufUnittest_UnittestProto3Extensions_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
extension ProtobufUnittest_Proto3FileExtensions {
  enum Extensions {
    static let singular_int = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, AppleSwiftProtobuf.Google_Protobuf_FileOptions>(
      _protobuf_fieldNumber: 1001,
      fieldName: "protobuf_unittest.Proto3FileExtensions.singular_int"
    )

    static let repeated_int = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.PackedExtensionField<AppleSwiftProtobuf.ProtobufInt32>, AppleSwiftProtobuf.Google_Protobuf_FileOptions>(
...
extension ProtobufUnittest_Proto3FileExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
