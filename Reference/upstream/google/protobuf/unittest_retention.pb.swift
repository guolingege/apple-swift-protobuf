...
enum ProtobufUnittest_TopLevelEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
struct ProtobufUnittest_Extendee: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
struct ProtobufUnittest_TopLevelMessage: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
extension AppleSwiftProtobuf.Google_Protobuf_ExtensionRangeOptions {
...
let ProtobufUnittest_UnittestRetention_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
let ProtobufUnittest_Extensions_plain_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, AppleSwiftProtobuf.Google_Protobuf_FileOptions>(
  _protobuf_fieldNumber: 505092806,
  fieldName: "protobuf_unittest.plain_option"
)

let ProtobufUnittest_Extensions_runtime_retention_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, AppleSwiftProtobuf.Google_Protobuf_FileOptions>(
  _protobuf_fieldNumber: 505039132,
  fieldName: "protobuf_unittest.runtime_retention_option"
)

let ProtobufUnittest_Extensions_source_retention_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, AppleSwiftProtobuf.Google_Protobuf_FileOptions>(
  _protobuf_fieldNumber: 504878676,
  fieldName: "protobuf_unittest.source_retention_option"
)

let ProtobufUnittest_Extensions_file_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_FileOptions>(
  _protobuf_fieldNumber: 504871168,
  fieldName: "protobuf_unittest.file_option"
)

let ProtobufUnittest_Extensions_repeated_options = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_FileOptions>(
  _protobuf_fieldNumber: 504823570,
  fieldName: "protobuf_unittest.repeated_options"
)

let ProtobufUnittest_Extensions_extension_range_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_ExtensionRangeOptions>(
  _protobuf_fieldNumber: 504822148,
  fieldName: "protobuf_unittest.extension_range_option"
)

let ProtobufUnittest_Extensions_message_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_MessageOptions>(
  _protobuf_fieldNumber: 504820819,
  fieldName: "protobuf_unittest.message_option"
)

let ProtobufUnittest_Extensions_field_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_FieldOptions>(
  _protobuf_fieldNumber: 504589219,
  fieldName: "protobuf_unittest.field_option"
)

let ProtobufUnittest_Extensions_oneof_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_OneofOptions>(
  _protobuf_fieldNumber: 504479153,
  fieldName: "protobuf_unittest.oneof_option"
)

let ProtobufUnittest_Extensions_enum_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_EnumOptions>(
  _protobuf_fieldNumber: 504451567,
  fieldName: "protobuf_unittest.enum_option"
)

let ProtobufUnittest_Extensions_enum_entry_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_EnumValueOptions>(
  _protobuf_fieldNumber: 504450522,
  fieldName: "protobuf_unittest.enum_entry_option"
)

let ProtobufUnittest_Extensions_service_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_ServiceOptions>(
  _protobuf_fieldNumber: 504387709,
  fieldName: "protobuf_unittest.service_option"
)

let ProtobufUnittest_Extensions_method_option = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<ProtobufUnittest_OptionsMessage>, AppleSwiftProtobuf.Google_Protobuf_MethodOptions>(
  _protobuf_fieldNumber: 504349420,
  fieldName: "protobuf_unittest.method_option"
)

let ProtobufUnittest_Extensions_i = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, ProtobufUnittest_Extendee>(
...
extension ProtobufUnittest_TopLevelMessage {
  enum Extensions {
    static let s = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, ProtobufUnittest_Extendee>(
...
extension ProtobufUnittest_TopLevelEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "TOP_LEVEL_UNKNOWN"),
  ]
}

extension ProtobufUnittest_OptionsMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_Extendee: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_TopLevelMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_TopLevelMessage.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "NESTED_UNKNOWN"),
  ]
}

extension ProtobufUnittest_TopLevelMessage.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
