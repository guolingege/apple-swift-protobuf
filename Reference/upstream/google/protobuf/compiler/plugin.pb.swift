...
struct Google_Protobuf_Compiler_CodeGeneratorRequest: Sendable {
  ...
  /// fully qualified.
  var protoFile: [AppleSwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []

  /// File descriptors with all options, including source-retention options.
  /// These descriptors are only provided for the files listed in
  /// files_to_generate.
  var sourceFileDescriptors: [AppleSwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []
...
struct Google_Protobuf_Compiler_CodeGeneratorResponse: Sendable {
  ...
  enum Feature: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  struct File: Sendable {
    ...
    var generatedCodeInfo: AppleSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo {
      get {return _generatedCodeInfo ?? AppleSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo()}
    ...
    fileprivate var _generatedCodeInfo: AppleSwiftProtobuf.Google_Protobuf_GeneratedCodeInfo? = nil
  }
...
extension Google_Protobuf_Compiler_Version: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension Google_Protobuf_Compiler_CodeGeneratorRequest: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
  ...
  public var isInitialized: Bool {
    if !AppleSwiftProtobuf.Internal.areAllInitialized(self.protoFile) {return false}
    if !AppleSwiftProtobuf.Internal.areAllInitialized(self.sourceFileDescriptors) {return false}
    return true
  }
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse.Feature: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse.File: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
