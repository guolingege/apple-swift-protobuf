...
struct ProtobufUnittest_TestStringViewExtension: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
let ProtobufUnittest_UnittestStringView_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
let ProtobufUnittest_Extensions_singular_string_view_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, ProtobufUnittest_TestStringViewExtension>(
  _protobuf_fieldNumber: 1,
  fieldName: "protobuf_unittest.singular_string_view_extension"
)

let ProtobufUnittest_Extensions_singular_bytes_view_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBytes>, ProtobufUnittest_TestStringViewExtension>(
  _protobuf_fieldNumber: 2,
  fieldName: "protobuf_unittest.singular_bytes_view_extension"
)

let ProtobufUnittest_Extensions_repeated_string_view_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufString>, ProtobufUnittest_TestStringViewExtension>(
  _protobuf_fieldNumber: 3,
  fieldName: "protobuf_unittest.repeated_string_view_extension"
)

let ProtobufUnittest_Extensions_repeated_bytes_view_extension = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.RepeatedExtensionField<AppleSwiftProtobuf.ProtobufBytes>, ProtobufUnittest_TestStringViewExtension>(
...
extension ProtobufUnittest_TestStringView: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_TestStringViewExtension: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
