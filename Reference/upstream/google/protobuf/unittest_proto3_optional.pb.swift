...
let ProtobufUnittest_UnittestProto3Optional_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
extension ProtobufUnittest_Proto3OptionalExtensions {
  enum Extensions {
    static let ext_no_optional = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, AppleSwiftProtobuf.Google_Protobuf_MessageOptions>(
      _protobuf_fieldNumber: 355886728,
      fieldName: "protobuf_unittest.Proto3OptionalExtensions.ext_no_optional"
    )

    static let ext_with_optional = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, AppleSwiftProtobuf.Google_Protobuf_MessageOptions>(
...
extension ProtobufUnittest_TestProto3Optional: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_TestProto3Optional.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    -1: .same(proto: "NEG"),
...
extension ProtobufUnittest_TestProto3Optional.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_TestProto3OptionalMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_TestProto3OptionalMessage.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufUnittest_Proto3OptionalExtensions: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
