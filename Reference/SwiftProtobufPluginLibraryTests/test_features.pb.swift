...
// Protos/AppleSwiftProtobufPluginLibraryTests/test_features.proto - test proto for Features
//
...
struct SwiftFeatureTest_TestFeatures: Sendable {
  ...
  enum EnumFeature: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
let SwiftFeatureTest_TestFeatures_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
let SwiftFeatureTest_Extensions_test = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalMessageExtensionField<SwiftFeatureTest_TestFeatures>, AppleSwiftProtobuf.Google_Protobuf_FeatureSet>(
...
extension SwiftFeatureTest_TestFeatures: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension SwiftFeatureTest_TestFeatures.EnumFeature: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
