...
extension SwiftDescriptorTest_EditionsMessageForDelimited: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: AppleSwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMap<AppleSwiftProtobuf.ProtobufInt32,AppleSwiftProtobuf.ProtobufString>.self, value: &_storage._mapField) }()
        case 3: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufInt32,SwiftDescriptorTest_EditionsMessageForDelimited>.self, value: &_storage._messageMapField) }()
  ...
  func traverse<V: AppleSwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._mapField.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMap<AppleSwiftProtobuf.ProtobufInt32,AppleSwiftProtobuf.ProtobufString>.self, value: _storage._mapField, fieldNumber: 2)
      }
      if !_storage._messageMapField.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufInt32,SwiftDescriptorTest_EditionsMessageForDelimited>.self, value: _storage._messageMapField, fieldNumber: 3)
      }
