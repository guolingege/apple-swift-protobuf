...
enum ProtobufTestMessages_Editions_ForeignEnumEdition2023: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
struct ProtobufTestMessages_Editions_TestAllTypesEdition2023: AppleSwiftProtobuf.ExtensibleMessage, @unchecked Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
let ProtobufTestMessages_Editions_TestMessagesEdition2023_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
let ProtobufTestMessages_Editions_Extensions_extension_int32 = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, ProtobufTestMessages_Editions_TestAllTypesEdition2023>(
  _protobuf_fieldNumber: 120,
  fieldName: "protobuf_test_messages.editions.extension_int32"
)

let ProtobufTestMessages_Editions_Extensions_GroupLikeType = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalGroupExtensionField<ProtobufTestMessages_Editions_GroupLikeType>, ProtobufTestMessages_Editions_TestAllTypesEdition2023>(
  _protobuf_fieldNumber: 121,
  fieldName: "protobuf_test_messages.editions.groupliketype"
)

let ProtobufTestMessages_Editions_Extensions_delimited_ext = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalGroupExtensionField<ProtobufTestMessages_Editions_GroupLikeType>, ProtobufTestMessages_Editions_TestAllTypesEdition2023>(
...
extension ProtobufTestMessages_Editions_ForeignEnumEdition2023: AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Editions_ComplexMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Editions_TestAllTypesEdition2023: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: AppleSwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 71: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_TestAllTypesEdition2023.NestedMessage>.self, value: &_storage._mapStringNestedMessage) }()
        case 72: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_ForeignMessageEdition2023>.self, value: &_storage._mapStringForeignMessage) }()
        case 73: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_TestAllTypesEdition2023.NestedEnum>.self, value: &_storage._mapStringNestedEnum) }()
        case 74: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_ForeignEnumEdition2023>.self, value: &_storage._mapStringForeignEnum) }()
  ...
  func traverse<V: AppleSwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._mapStringNestedMessage.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_TestAllTypesEdition2023.NestedMessage>.self, value: _storage._mapStringNestedMessage, fieldNumber: 71)
      }
      if !_storage._mapStringForeignMessage.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_ForeignMessageEdition2023>.self, value: _storage._mapStringForeignMessage, fieldNumber: 72)
      }
      if !_storage._mapStringNestedEnum.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_TestAllTypesEdition2023.NestedEnum>.self, value: _storage._mapStringNestedEnum, fieldNumber: 73)
      }
      if !_storage._mapStringForeignEnum.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Editions_ForeignEnumEdition2023>.self, value: _storage._mapStringForeignEnum, fieldNumber: 74)
      }
...
extension ProtobufTestMessages_Editions_TestAllTypesEdition2023.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    -1: .same(proto: "NEG"),
    0: .same(proto: "FOO"),
    1: .same(proto: "BAR"),
...
extension ProtobufTestMessages_Editions_TestAllTypesEdition2023.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Editions_TestAllTypesEdition2023.GroupLikeType: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Editions_ForeignMessageEdition2023: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Editions_GroupLikeType: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
