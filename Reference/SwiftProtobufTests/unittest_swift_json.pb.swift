...
struct SwiftProtoTesting_SwiftJSONTest: Sendable {
  ...
  var repeatedNullValue: [AppleSwiftProtobuf.Google_Protobuf_NullValue] = []
...
extension SwiftProtoTesting_SwiftJSONTest: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
