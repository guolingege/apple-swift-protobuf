...
struct SwiftProtoTesting_Order_TestFieldOrderings: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
...
struct SwiftProtoTesting_Order_OneofTraversalGeneration: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
  // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
  // methods supported on all messages.
...
let SwiftProtoTesting_Order_UnittestSwiftFieldorder_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
let SwiftProtoTesting_Order_Extensions_my_extension_string = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufString>, SwiftProtoTesting_Order_TestFieldOrderings>(
  _protobuf_fieldNumber: 50,
  fieldName: "swift_proto_testing.order.my_extension_string"
)

let SwiftProtoTesting_Order_Extensions_my_extension_int = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufInt32>, SwiftProtoTesting_Order_TestFieldOrderings>(
...
extension SwiftProtoTesting_Order_TestFieldOrderings: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension SwiftProtoTesting_Order_TestFieldOrderings.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension SwiftProtoTesting_Order_OneofTraversalGeneration: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
