...
struct SwiftProtoTesting_SwiftReservedTest: Sendable {
  ...
  struct classMessage: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
    // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
    // methods supported on all messages.
  ...
  struct TypeMessage: AppleSwiftProtobuf.ExtensibleMessage, Sendable {
    // AppleSwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the AppleSwiftProtobuf library for
    // methods supported on all messages.
...
let SwiftProtoTesting_UnittestSwiftReserved_Extensions: AppleSwiftProtobuf.SimpleExtensionMap = [
...
/// Won't get _p added because it is fully qualified.
let SwiftProtoTesting_Extensions_debug_description = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
...
/// These are scoped to the file, so the package prefix (or a Swift prefix)
/// will get added to them to they aren't going to get renamed.
let SwiftProtoTesting_Extensions_as = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1012,
  fieldName: "swift_proto_testing.as"
)

let SwiftProtoTesting_Extensions_var = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1013,
  fieldName: "swift_proto_testing.var"
)

let SwiftProtoTesting_Extensions_try = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1014,
  fieldName: "swift_proto_testing.try"
)

let SwiftProtoTesting_Extensions_do = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1015,
  fieldName: "swift_proto_testing.do"
)

let SwiftProtoTesting_Extensions_nil = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
...
extension SwiftProtoTesting_SwiftReservedTestExt {
  enum Extensions {
    ...
    /// the raw form is used ("hash_value", not the Swift one "hashValue"),
    /// so there is no conflict, and no renaming happens.
    static let hash_value = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
    ...
    /// Reserved words, since these end up in the "struct Extensions", they
    /// can't just be get their names, and sanitation kicks.
    static let `as` = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1022,
      fieldName: "swift_proto_testing.SwiftReservedTestExt.as"
    )

    static let `var` = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1023,
      fieldName: "swift_proto_testing.SwiftReservedTestExt.var"
    )

    static let `try` = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1024,
      fieldName: "swift_proto_testing.SwiftReservedTestExt.try"
    )

    static let `do` = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1025,
      fieldName: "swift_proto_testing.SwiftReservedTestExt.do"
    )

    static let `nil` = AppleSwiftProtobuf.MessageExtension<AppleSwiftProtobuf.OptionalExtensionField<AppleSwiftProtobuf.ProtobufBool>, SwiftProtoTesting_SwiftReservedTest.classMessage>(
...
extension SwiftProtoTesting_SwiftReservedTest: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension SwiftProtoTesting_SwiftReservedTest.Enum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    1: .same(proto: "DOUBLE"),
    2: .same(proto: "JSON"),
    3: .same(proto: "CLASS"),
...
extension SwiftProtoTesting_SwiftReservedTest.ProtocolEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    1: .same(proto: "a"),
  ]
}

extension SwiftProtoTesting_SwiftReservedTest.classMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension SwiftProtoTesting_SwiftReservedTest.TypeMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension SwiftProtoTesting_SwiftReservedTest.isEqual: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension SwiftProtoTesting_SwiftReservedTestExt: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
