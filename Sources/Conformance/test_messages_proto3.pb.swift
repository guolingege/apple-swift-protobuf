...
enum ProtobufTestMessages_Proto3_ForeignEnum: AppleSwiftProtobuf.Enum, Swift.CaseIterable {
...
extension ProtobufTestMessages_Proto3_ForeignEnum: AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Proto3_TestAllTypesProto3: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: AppleSwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 71: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedMessage>.self, value: &_storage._mapStringNestedMessage) }()
        case 72: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_ForeignMessage>.self, value: &_storage._mapStringForeignMessage) }()
        case 73: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedEnum>.self, value: &_storage._mapStringNestedEnum) }()
        case 74: try { try decoder.decodeMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_ForeignEnum>.self, value: &_storage._mapStringForeignEnum) }()
  ...
  func traverse<V: AppleSwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._mapStringNestedMessage.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedMessage>.self, value: _storage._mapStringNestedMessage, fieldNumber: 71)
      }
      if !_storage._mapStringForeignMessage.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufMessageMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_ForeignMessage>.self, value: _storage._mapStringForeignMessage, fieldNumber: 72)
      }
      if !_storage._mapStringNestedEnum.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedEnum>.self, value: _storage._mapStringNestedEnum, fieldNumber: 73)
      }
      if !_storage._mapStringForeignEnum.isEmpty {
        try visitor.visitMapField(fieldType: AppleSwiftProtobuf._ProtobufEnumMap<AppleSwiftProtobuf.ProtobufString,ProtobufTestMessages_Proto3_ForeignEnum>.self, value: _storage._mapStringForeignEnum, fieldNumber: 74)
      }
...
extension ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    -1: .same(proto: "NEG"),
    0: .same(proto: "FOO"),
    1: .same(proto: "BAR"),
...
extension ProtobufTestMessages_Proto3_TestAllTypesProto3.AliasedEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
...
extension ProtobufTestMessages_Proto3_TestAllTypesProto3.NestedMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Proto3_ForeignMessage: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Proto3_NullHypothesisProto3: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Proto3_EnumOnlyProto3: AppleSwiftProtobuf.Message, AppleSwiftProtobuf._MessageImplementationBase, AppleSwiftProtobuf._ProtoNameProviding {
...
extension ProtobufTestMessages_Proto3_EnumOnlyProto3.BoolEnum: AppleSwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: AppleSwiftProtobuf._NameMap = [
    0: .same(proto: "kFalse"),
    1: .same(proto: "kTrue"),
  ]
